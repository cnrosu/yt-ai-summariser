...
See [docs/api-reference.md](docs/api-reference.md) for details on the available endpoints and how to run the server. For information about the automated test suite see [docs/TESTING.md](docs/TESTING.md).
